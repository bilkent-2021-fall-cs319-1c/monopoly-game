...
public class TradePane extends MigPane {
    ...
    public TradePane(@NamedArg("playerOneName") String playerOneName,
                     @NamedArg("playerTwoName") String playerTwoName,
                     @NamedArg("playerOneAssets") Node[] playerOneAssets,
                     @NamedArg("playerTwoAssets") Node[] playerTwoAssets,
